...
namespace HYKJ
{
    public class ClaykilnWidget : CanvasWidget
    {
        ...
        public ClaykilnWidget(IInventory inventory, ComponentFurnace componentFurnace)
        {
            m_componentFurnace = componentFurnace;
            XElement node = ContentManager.Get<XElement>("Widgets/ClaykilnWidget");
