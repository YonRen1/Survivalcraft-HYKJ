...
namespace HYKJ
{
    ...
    public class HYKJClothingWidget : CanvasWidget
    {
        ...
        public ValueBarWidget m_waterValueBar;
        ...
        public HYKJClothingWidget(ComponentPlayer componentPlayer)
        {
            ...
            m_waterValueBar = Children.Find<ValueBarWidget>("waterValueBar");
        ...
        public override void Update()
        {
            ...
            //m_waterValueBar.Value = componentThirst.Water;
        }
    }
    public class newFurnaceWidget : CanvasWidget
    {
        public GridPanelWidget m_inventoryGrid;
        ...
        public NewComponentFurnace m_newcomponentFurnace;

        public newFurnaceWidget(IInventory inventory, ComponentFurnace newcomponentFurnace)
        {
            //m_newcomponentFurnace = newcomponentFurnace;
            XElement node = ContentManager.Get<XElement>("HYKJWidgets/FurnaceWidget");
            LoadContents(this, node);
            m_inventoryGrid = Children.Find<GridPanelWidget>("InventoryGrid");
            ...
            for (int k = 0; k < m_furnaceGrid.RowsCount; k++)
            {
                ...
                {
                    var inventorySlotWidget2 = new InventorySlotWidget();
                    inventorySlotWidget2.AssignInventorySlot(newcomponentFurnace, num++);
                    m_furnaceGrid.Children.Add(inventorySlotWidget2);
                    m_furnaceGrid.SetWidgetCell(inventorySlotWidget2, new Point2(l, k));
                }
            }
            m_fuelSlot.AssignInventorySlot(newcomponentFurnace, newcomponentFurnace.FuelSlotIndex);
            m_resultSlot.AssignInventorySlot(newcomponentFurnace, newcomponentFurnace.ResultSlotIndex);
            m_remainsSlot.AssignInventorySlot(newcomponentFurnace, newcomponentFurnace.RemainsSlotIndex);
        }

        public override void Update()
        {
            m_fire.ParticlesPerSecond = (m_newcomponentFurnace.HeatLevel > 0f) ? 24 : 0;
            m_progress.Value = m_newcomponentFurnace.SmeltingProgress;
            if (!m_newcomponentFurnace.IsAddedToProject)
            {
                ParentWidget.Children.Remove(this);
            }
        }
